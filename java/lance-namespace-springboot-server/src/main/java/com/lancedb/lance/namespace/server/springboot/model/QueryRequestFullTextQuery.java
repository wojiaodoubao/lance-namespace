...
@Schema(
    name = "QueryRequest_full_text_query",
    description =
        "Optional full-text search query. Provide either string_query or structured_query, not both.")
...
public class QueryRequestFullTextQuery {
  ...
  public QueryRequestFullTextQuery stringQuery(StringFtsQuery stringQuery) {
  ...
  public QueryRequestFullTextQuery structuredQuery(StructuredFtsQuery structuredQuery) {
