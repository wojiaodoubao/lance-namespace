...
public interface TableApi {
  ...
  /**
   * POST /DeregisterTable : Deregister a table from its namespace Deregister a table from its
   * namespace. The table content remains available in the storage.
   *
  ...
  /**
   * POST /DropTable : Drop a table from its namespace Drop a table from its namespace and delete
   * its data. If the table and its data can be immediately deleted, return information of the
   * deleted table. Otherwise, return a transaction ID that client can use to track deletion
   * progress.
   *
