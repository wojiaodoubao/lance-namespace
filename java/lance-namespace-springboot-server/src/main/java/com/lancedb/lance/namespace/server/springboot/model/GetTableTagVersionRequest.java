...
public class GetTableTagVersionRequest {
  ...
  public GetTableTagVersionRequest(String tag) {
    this.tag = tag;
  }

  public GetTableTagVersionRequest id(List<String> id) {
    this.id = id;
    return this;
  }

  public GetTableTagVersionRequest addIdItem(String idItem) {
    if (this.id == null) {
  ...
  public GetTableTagVersionRequest tag(String tag) {
    this.tag = tag;
    return this;
  }
