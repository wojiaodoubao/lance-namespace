...
public class IndexStatsRequest {
  ...
  public IndexStatsRequest(String name, List<String> namespace) {
    this.name = name;
    this.namespace = namespace;
  }

  public IndexStatsRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public IndexStatsRequest namespace(List<String> namespace) {
    this.namespace = namespace;
    return this;
  }
  ...
  public IndexStatsRequest version(Long version) {
