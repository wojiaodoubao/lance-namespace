...
public class IndexStatsResponse {
  ...
  public IndexStatsResponse distanceType(String distanceType) {
  ...
  public IndexStatsResponse indexType(String indexType) {
  ...
  public IndexStatsResponse numIndexedRows(Long numIndexedRows) {
  ...
  public IndexStatsResponse numUnindexedRows(Long numUnindexedRows) {
