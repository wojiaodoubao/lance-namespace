...
public class JsonUtil {
  ...
  public static int getInt(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing int: %s", property);
  ...
  public static long getLong(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing long: %s", property);
    JsonNode pNode = node.get(property);
    ValidationUtil.checkArgument(
  ...
  public static boolean getBool(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing boolean: %s", property);
    JsonNode pNode = node.get(property);
    ValidationUtil.checkArgument(
  ...
  public static String getString(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing string: %s", property);
    JsonNode pNode = node.get(property);
    ValidationUtil.checkArgument(
  ...
  public static Map<String, String> getStringMap(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing map: %s", property);
    JsonNode pNode = node.get(property);
    ValidationUtil.checkArgument(
  ...
  public static List<String> getStringList(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing list: %s", property);
  ...
  public static Set<String> getStringSet(String property, JsonNode node) {
    ValidationUtil.checkArgument(node.has(property), "Cannot parse missing set: %s", property);
  ...
  public static void writeIntegerArrayField(
      String property, Iterable<Integer> items, JsonGenerator gen) throws IOException {
  ...
  public static void writeLongArrayField(String property, Iterable<Long> items, JsonGenerator gen)
      throws IOException {
    gen.writeArrayFieldStart(property);
    for (Long item : items) {
      gen.writeNumber(item);
  ...
  public static void writeStringArrayField(
      String property, Iterable<String> items, JsonGenerator gen) throws IOException {
    gen.writeArrayFieldStart(property);
  ...
  public static void writeStringMapField(
      String property, Map<String, String> map, JsonGenerator gen) throws IOException {
  ...
  public static void writeStringMap(Map<String, String> map, JsonGenerator gen) throws IOException {
