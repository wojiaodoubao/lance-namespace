...
public class LanceRestNamespaceBuilder {
  ...
  private LanceRestNamespaceBuilder() {}
  ...
  public static LanceRestNamespaceBuilder builder() {
    return new LanceRestNamespaceBuilder();
  }
   ...
   * @return This builder
   */
  public LanceRestNamespaceBuilder apiKey(String apiKey) {
   ...
   * @return This builder
   */
  public LanceRestNamespaceBuilder database(String database) {
   ...
   * @return This builder
   */
  public LanceRestNamespaceBuilder hostOverride(String hostOverride) {
   ...
   * @return This builder
   */
  public LanceRestNamespaceBuilder region(String region) {
   ...
   * @return This builder
   */
  public LanceRestNamespaceBuilder config(String key, String value) {
