...
public class Hive3ClientPool extends ClientPoolImpl<IMetaStoreClient, TException> {
  ...
  protected IMetaStoreClient newClient() {
    try {
      ...
      throw new Hive3MetaException(e, "Failed to connect to Hive 3.x Metastore");
    } catch (Throwable t) {
      if (t.getMessage() != null
          && t.getMessage().contains("Another instance of Derby may have already booted")) {
        throw new Hive3MetaException(
            t,
      ...
      throw new Hive3MetaException(t, "Failed to connect to Hive 3.x Metastore");
    }
  }
  ...
  protected IMetaStoreClient reconnect(IMetaStoreClient client) {
    try {
      ...
      throw new Hive3MetaException(e, "Failed to reconnect to Hive 3.x Metastore");
    }
    return client;
  }
