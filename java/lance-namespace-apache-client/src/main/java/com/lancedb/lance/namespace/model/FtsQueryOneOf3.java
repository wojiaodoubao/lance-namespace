...
/** FtsQueryOneOf3 */
@JsonPropertyOrder({FtsQueryOneOf3.JSON_PROPERTY_MULTI_MATCH})
@JsonTypeName("FtsQuery_oneOf_3")
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class FtsQueryOneOf3 {
  ...
  public FtsQueryOneOf3 multiMatch(@javax.annotation.Nonnull MultiMatchQuery multiMatch) {
