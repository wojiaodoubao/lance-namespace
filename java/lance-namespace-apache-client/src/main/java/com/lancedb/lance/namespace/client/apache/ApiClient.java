...
import com.lancedb.lance.namespace.client.apache.auth.Authentication;
                  ...
                  new HashMap<String, ServerVariable>() {
                    {
                      put(
                          "scheme",
                          new ServerVariable(
                              "No description provided", "http", new HashSet<String>()));
                      put(
                          "host",
                          new ServerVariable(
                              "No description provided", "localhost", new HashSet<String>()));
                      put(
                          "port",
                          new ServerVariable(
                              "No description provided", "2333", new HashSet<String>()));
                      put(
                          "basePath",
                          new ServerVariable("No description provided", "", new HashSet<String>()));
                    }
                  }),
              new ServerConfiguration(
