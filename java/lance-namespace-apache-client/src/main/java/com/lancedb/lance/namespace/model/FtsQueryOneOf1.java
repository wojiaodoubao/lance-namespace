...
/** FtsQueryOneOf1 */
@JsonPropertyOrder({FtsQueryOneOf1.JSON_PROPERTY_PHRASE})
@JsonTypeName("FtsQuery_oneOf_1")
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class FtsQueryOneOf1 {
  ...
  public FtsQueryOneOf1 phrase(@javax.annotation.Nonnull PhraseQuery phrase) {
