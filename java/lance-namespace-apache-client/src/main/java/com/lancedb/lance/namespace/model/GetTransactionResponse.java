...
@JsonPropertyOrder({
  GetTransactionResponse.JSON_PROPERTY_ID,
  GetTransactionResponse.JSON_PROPERTY_STATUS,
  GetTransactionResponse.JSON_PROPERTY_PROPERTIES
})
...
public class GetTransactionResponse {
  ...
  public GetTransactionResponse id(@javax.annotation.Nonnull String id) {
  ...
  public GetTransactionResponse status(@javax.annotation.Nonnull TransactionStatus status) {
  ...
  public GetTransactionResponse properties(
