...
@JsonPropertyOrder({
  QueryRequestFullTextQuery.JSON_PROPERTY_STRING_QUERY,
  QueryRequestFullTextQuery.JSON_PROPERTY_STRUCTURED_QUERY
})
@JsonTypeName("QueryRequest_full_text_query")
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class QueryRequestFullTextQuery {
  ...
  public QueryRequestFullTextQuery() {}

  public QueryRequestFullTextQuery stringQuery(
  ...
  public QueryRequestFullTextQuery structuredQuery(
  ...
  public boolean equals(Object o) {
    ...
    QueryRequestFullTextQuery queryRequestFullTextQuery = (QueryRequestFullTextQuery) o;
    return Objects.equals(this.stringQuery, queryRequestFullTextQuery.stringQuery)
        && Objects.equals(this.structuredQuery, queryRequestFullTextQuery.structuredQuery);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryRequestFullTextQuery {\n");
