...
from lance_catalog_urllib3_client.api_response import ApiResponse, T as ApiResponseT
import lance_catalog_urllib3_client.models
from lance_catalog_urllib3_client import rest
from lance_catalog_urllib3_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lance_catalog_urllib3_client.models, klass)
