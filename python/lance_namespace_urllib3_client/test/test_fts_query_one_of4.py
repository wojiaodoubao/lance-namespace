...
class TestFtsQueryOneOf4(unittest.TestCase):
    """FtsQueryOneOf4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FtsQueryOneOf4:
        """Test FtsQueryOneOf4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FtsQueryOneOf4`
        """
        model = FtsQueryOneOf4()
        if include_optional:
            return FtsQueryOneOf4(
