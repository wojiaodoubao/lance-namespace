...
class TestIndexStatsResponse(unittest.TestCase):
    """IndexStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexStatsResponse:
        """Test IndexStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexStatsResponse`
        """
        model = IndexStatsResponse()
        if include_optional:
    ...
    def testIndexStatsResponse(self):
        """Test IndexStatsResponse"""
