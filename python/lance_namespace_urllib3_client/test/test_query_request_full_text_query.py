...
class TestQueryRequestFullTextQuery(unittest.TestCase):
    """QueryRequestFullTextQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryRequestFullTextQuery:
        """Test QueryRequestFullTextQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryRequestFullTextQuery`
        """
        model = QueryRequestFullTextQuery()
        if include_optional:
            return QueryRequestFullTextQuery(
    ...
    def testQueryRequestFullTextQuery(self):
        """Test QueryRequestFullTextQuery"""
