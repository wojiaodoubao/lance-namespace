...
class TestQueryTableRequest(unittest.TestCase):
    """QueryTableRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryTableRequest:
        """Test QueryTableRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryTableRequest`
        """
    ...
    def testQueryTableRequest(self):
        """Test QueryTableRequest"""
