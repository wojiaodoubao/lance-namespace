...
class TestFtsQueryOneOf1(unittest.TestCase):
    """FtsQueryOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FtsQueryOneOf1:
        """Test FtsQueryOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FtsQueryOneOf1`
        """
        model = FtsQueryOneOf1()
        if include_optional:
            return FtsQueryOneOf1(
