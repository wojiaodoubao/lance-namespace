...
class TestIndexStatsRequest(unittest.TestCase):
    """IndexStatsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexStatsRequest:
        """Test IndexStatsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexStatsRequest`
        """
        model = IndexStatsRequest()
        if include_optional:
    ...
    def testIndexStatsRequest(self):
        """Test IndexStatsRequest"""
