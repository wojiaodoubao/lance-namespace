...
class TestMergeInsertTableResponse(unittest.TestCase):
    """MergeInsertTableResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MergeInsertTableResponse:
        """Test MergeInsertTableResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergeInsertTableResponse`
        """
        model = MergeInsertTableResponse()
        if include_optional:
    ...
    def testMergeInsertTableResponse(self):
        """Test MergeInsertTableResponse"""
