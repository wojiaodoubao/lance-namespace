...
class TestJsonArrowSchema(unittest.TestCase):
    """JsonArrowSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonArrowSchema:
        """Test JsonArrowSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonArrowSchema`
        """
        model = JsonArrowSchema()
        if include_optional:
