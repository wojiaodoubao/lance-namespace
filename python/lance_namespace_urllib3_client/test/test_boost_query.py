...
class TestBoostQuery(unittest.TestCase):
    """BoostQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoostQuery:
        """Test BoostQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoostQuery`
        """
        model = BoostQuery()
        if include_optional:
            return BoostQuery(
                ...
                negative = lance_namespace_urllib3_client.models.fts_query.FtsQuery(
                    match = lance_namespace_urllib3_client.models.match_query.MatchQuery(
                        boost = 1.337, 
                        column = '', 
                        fuzziness = 0, 
