...
class TestGetTransactionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionRequest:
        """Test GetTransactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionRequest`
        """
        model = GetTransactionRequest()
        if include_optional:
