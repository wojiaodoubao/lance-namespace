...
class TestIndexListRequest(unittest.TestCase):
    """IndexListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexListRequest:
        """Test IndexListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexListRequest`
        """
        model = IndexListRequest()
        if include_optional:
