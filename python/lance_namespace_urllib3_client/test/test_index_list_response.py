...
class TestIndexListResponse(unittest.TestCase):
    """IndexListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexListResponse:
        """Test IndexListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexListResponse`
        """
    ...
    def testIndexListResponse(self):
        """Test IndexListResponse"""
