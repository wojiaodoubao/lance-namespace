...
class DropTableIndexResponse(BaseModel):
    """
    DropTableIndexResponse
    """ # noqa: E501
    version: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Version of the table after dropping the index")
