...
class AlterTableAlterColumnsRequest(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.alterations:
            for _item_alterations in self.alterations:
                if _item_alterations:
                    _items.append(_item_alterations.to_dict())
            _dict['alterations'] = _items
        return _dict
