...
class QueryRequestVector(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["single_vector", "multi_vector"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "single_vector": obj.get("single_vector"),
            "multi_vector": obj.get("multi_vector")
        })
        return _obj
