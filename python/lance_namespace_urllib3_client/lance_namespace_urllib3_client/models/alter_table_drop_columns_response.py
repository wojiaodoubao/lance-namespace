...
class AlterTableDropColumnsResponse(BaseModel):
    """
    AlterTableDropColumnsResponse
    """ # noqa: E501
    version: Annotated[int, Field(strict=True, ge=0)] = Field(description="Version of the table after dropping columns")
